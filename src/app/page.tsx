    ...
    <>
      <section className="relative overflow-hidden bg-blue-800 text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32">
          ...
          <h1 className="mt-4 max-w-2xl text-5xl font-bold tracking-tight sm:text-6xl">
            {site.name}
          </h1>
          ...
          <div className="mt-10 flex gap-4">
            <Link
              href="/research"
              className="rounded-md bg-white px-5 py-3 text-sm font-semibold text-blue-800 hover:bg-blue-50"
            >
              Explore Research
            </Link>
            <Link
              href="/contact"
              className="rounded-md border border-white/50 px-5 py-3 text-sm font-semibold text-white hover:border-white"
            >
              Contact
            </Link>
          </div>
